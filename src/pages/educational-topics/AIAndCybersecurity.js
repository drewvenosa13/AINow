...
const AIAndCybersecurity = () => {
  ...
  useEffect(() => {
    ...
    const newsQuery = query(articlesRef, where("topic", "==", "cybersecurity"), where("intent", "==", "News"), orderBy('createdAt', 'desc'));
    const educationQuery = query(articlesRef, where("topic", "==", "cybersecurity"), where("intent", "==", "Education"), orderBy('createdAt', 'desc'));
  ...
  return (
    <div className="cybersecurity-page">
      ...
      <p> Discussing the Implications of AI in Cybersecurity </p>
...
export default AIAndCybersecurity;
